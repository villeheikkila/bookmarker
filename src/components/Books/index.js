...
export const Books = ({books}) => {
    ...
    const sortByAuthor = () => {
        const clone = sortDirections.author ? _.sortBy(sortedBooks, ['author']) : _.sortBy(sortedBooks, ['author']).reverse()
    ...
    const sortByTitle = () => {
        const clone = sortDirections.title ? _.sortBy(sortedBooks, ['title']) : _.sortBy(sortedBooks, ['title']).reverse()
        setSortedBooks(clone)
        setSortDirections(prev => ({
            ...prev,
            title: !prev.title
    ...
    const sortByYear = () => {
        const clone = sortDirections.year ? _.sortBy(sortedBooks, function (book) {
